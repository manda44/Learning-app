...
namespace LearningApp.Controllers
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<object>> GetUserProgression()
        {
            try
            {
        ...
        public ActionResult<IEnumerable<object>> GetMonthlyActivity()
        {
            try
            {
        ...
        public ActionResult<IEnumerable<object>> GetPopularCourses()
        {
            try
            {
        ...
        public ActionResult<object> GetEnrollmentStats()
        {
            try
            {
        ...
        public ActionResult<object> GetTicketStats()
        {
            try
            {
